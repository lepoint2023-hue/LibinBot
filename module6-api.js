/* ═══════════════════════════════════════════════════════════
   ...
   Commune de Libin · v7.0
   ═══════════════════════════════════════════════════════════ */

const PROXY_URL = "https://libinbot.lepoint2023.workers.dev/llm"; /* ⚠️ à mettre à jour avec l'URL réelle une fois le Worker Cloudflare créé */
...
const MSG_ERREUR = {
  fr: "Désolé, je n'ai pas pu traiter votre demande. Contactez-nous au **+32 61 26 08 10**.",
  nl: "Sorry, uw verzoek kon niet worden verwerkt. Bel ons op **+32 61 26 08 10**.",
  de: "Entschuldigung, Ihre Anfrage konnte nicht bearbeitet werden. Rufen Sie uns an: **+32 61 26 08 10**.",
};

const MSG_CONNEXION = {
  fr: "⚠️ Connexion indisponible. Contactez-nous au **+32 61 26 08 10** ou via www.libin.be.",
  nl: "⚠️ Verbinding niet beschikbaar. Bel **+32 61 26 08 10** of via www.libin.be.",
  de: "⚠️ Verbindung nicht verfügbar. Rufen Sie uns an: **+32 61 26 08 10** oder www.libin.be.",
};

const MSG_QUOTA = {
  fr: "⚠️ Le service est temporairement saturé. Réessayez dans quelques instants ou appelez-nous au **+32 61 26 08 10**.",
  nl: "⚠️ De service is tijdelijk overbelast. Probeer het later opnieuw of bel **+32 61 26 08 10**.",
  de: "⚠️ Der Dienst ist vorübergehend überlastet. Versuchen Sie es später oder rufen Sie **+32 61 26 08 10** an.",
};

const MSG_TIMEOUT = {
  fr: "⚠️ La réponse prend trop de temps. Vérifiez votre connexion ou contactez-nous au **+32 61 26 08 10**.",
  nl: "⚠️ Het antwoord duurt te lang. Controleer uw verbinding of bel **+32 61 26 08 10**.",
  de: "⚠️ Die Antwort dauert zu lange. Überprüfen Sie Ihre Verbindung oder rufen Sie **+32 61 26 08 10** an.",
};
