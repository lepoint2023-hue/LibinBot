...
const GREETINGS = {
  fr: "Bonjour, je suis LibinBot. Quelle est votre question ?",
  nl: "Goedag, ik ben LibinBot. Wat is uw vraag?",
  de: "Guten Tag, ich bin LibinBot. Was möchten Sie wissen?",
};
...
/* "LibinBot" : vérifier à l'usage si la prononciation TTS pose problème —
...
.replace(/\bLibramontBot\b/gi, 'Libramontbotte') /* garder tel quel : sans effet, "LibinBot" ne contient pas ce mot */
.trim();
}
    ...
    _ensureVoices(() => {
      ...
      function speakNext() {
        ...
        utt.onerror = (e) => {
          ...
          console.warn('[LibinBot Voice] TTS chunk', idx, ':', e.error);
...
function startListening() {
  ...
  _recognition.onerror = (e) => {
    ...
    console.warn('[LibinBot Voice] STT:', e.error);
    _setState('error_stt');
